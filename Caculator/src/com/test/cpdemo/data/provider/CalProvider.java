 ...
 */
public final class CalProvider extends ContentProvider {

    private static final String LOG_TAG = CalProvider.class.getSimpleName();

    /* package */ static final boolean ACTIVATE_ALL_LOGS = false;

    protected static final String DATABASE_NAME = "CalProvider.db";

    public static final String AUTHORITY = "com.test.cpdemo.provider.CalProvider";
    ...
    private enum UriType {
        HISTORY(history.TABLE_NAME, history.TABLE_NAME, history.TYPE_ELEM_TYPE),
        HISTORY_ID(history.TABLE_NAME + "/#", history.TABLE_NAME, history.TYPE_DIR_TYPE);
    ...
    private class DatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            Log.d(LOG_TAG, "Creating CalProvider database");
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            history.upgradeTable(db, oldVersion, newVersion);
        }
    ...
    public int bulkInsert(Uri uri, ContentValues[] values) {
        ...
        try {
            switch (uriType) {
                case HISTORY:
                    insertStmt = db.compileStatement(history.getBulkInsertString());
                    for (ContentValues value : values) {
                        history.bindValuesInBulkInsert(insertStmt, value);
                        insertStmt.execute();
